var kripton = function() {
    ...
    return {
        init: function() {
            ...
            jQuery(".metismenu > .ms-active ").each(function() {
            ...
            function() {
                for (var e = window.location, t = $("ul#menu a").filter(function() {
                    return this.href == e
                }).addClass("ms-active").parent().addClass("ms-active"); t.is("li"); )
                    t = t.parent().addClass("ms-show").parent().addClass("ms-active")
            }(),
            ...
            ((o = window.outerHeight) > 0 ? o : screen.height) && $(".content-body").css("min-height", o + 60 + "px"),
            ...
            function() {
                new PerfectScrollbar(".dz-demo-content");
        ...
        load: function() {
            ...
            function() {
                ...
                e.find("option").each((e,t)=>{
                    const n = $(t)
                      , o = n.attr("data-thumbnail");
                    o && n.attr("data-content", "<img src='%i'/> %s".replace(/%i/, o).replace(/%s/, n.text())),
                    console.warn("option:", e, n)
                }
                ),
                e.selectpicker()
            }(),
            jQuery("body").append('<script id="DZScript" src="assets/assetsdash/js/w3-global.js?btn_dir=left"><\/script>')
        },
        resize: function() {
            n()
        }
